                    ...
                    <div class="col-md-6 col-sm-7">
                        <div class="list-menu">
                            <ul>
                                ...
                                <li><a href="product-detail.html">Details </a></li> <!--temp tbc -->
                                <li><a href="contact.html">Contact </a></li> <!--temp tbc -->
                            </ul>
                        </div> <!-- /.list-menu -->
                    </div> <!-- /.col-md-6 -->
                    <div class="col-md-6 col-sm-5">
                        <div class="notification">
                            <span>Save 10% on any product by using code:10OFF</span>
                        </div>
                    </div> <!-- /.col-md-6 -->
                </div> <!-- /.row -->
            </div> <!-- /.container -->
